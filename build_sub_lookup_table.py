...
def main():
    ...
    parser.add_argument('--simulation-name', type=str,help='name of simulation',default=None)
    parser.add_argument('--tag', type=str,help='tag for snapshot',default=None)
    parser.add_argument('--snap', type=str,help='tag for snapshot',default=None)
    ...
    parser.add_argument('--moar', type=json.loads,help='Additional subfind data',default='false')
