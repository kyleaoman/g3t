...
DB=/tmp/antonio/magneticum.sql.faster
...
#(Box4uhr_bao_z05; /usr/bin/ python csv_to_sql.py --simulation-name $NAME --snap $SNAP --outfile output/_HydroSims_Magneticum_Box4_uhr_test__${TAG}_$PROPS.* $PARAM)
#(Box4uhr_bao_z1; /usr/bin/ python csv_to_sql.py --simulation-name $NAME --snap $SNAP --outfile output/_HydroSims_Magneticum_Box4_uhr_test__${TAG}_$PROPS.* $PARAM)
#(Box4uhr_bao_z15; /usr/bin/ python csv_to_sql.py --simulation-name $NAME --snap $SNAP --outfile output/_HydroSims_Magneticum_Box4_uhr_test__${TAG}_$PROPS.* $PARAM)
#(Box4uhr_bao_z2; /usr/bin/ python csv_to_sql.py --simulation-name $NAME --snap $SNAP --outfile output/_HydroSims_Magneticum_Box4_uhr_test__${TAG}_$PROPS.* $PARAM)
